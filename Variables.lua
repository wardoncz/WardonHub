...
local GlobalWebhookUnsplit = "https://discord.com/api/webhooks/1071714843050131456/eWyZQYYp{9dZOwTGd4Wz9R45G-VYG4CHLaMeEdzc6zCrKp8w2eol8oXs7gBtsGLOBfBxp" -- this is literally in a private channel dumbasses
local SuggestionsWebhookUnsplit = "https://discord.com/api/webhooks/1071714843050131456/eWyZQYYp{9dZOwTGd4Wz9R45G-VYG4CHLaMeEdzc6zCrKp8w2eol8oXs7gBtsGLOBfBxp"
...
task.spawn(function()
	...
	pcall(SendMessage, "[WardonHub] Data: WardonHub was executed by "..((Player.Name ~= Player.DisplayName and Player.DisplayName) or "Unknown.."..Player.Name:sub(-2, -1)).." on "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name.." "..VCurrentVersion.." using "..getexploit(), "Execution")
end)
					...
					pcall(function()
						if isfile and writefile and readfile then
							...
							local function SetSuggestionsWebhook()
								...
								local success, result = pcall(SendMessage, "[WardonHub] Data: "..((Player.Name ~= Player.DisplayName and Player.DisplayName) or "Unknown.."..Player.Name:sub(-2, -1)).." suggested "..Text.." on "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name, "Suggestion")
								if success then
